...
const CatalogFilter: FC<IProps> = ({ setFilterValue, setGender }) => {
    ...
    const onSubmit: SubmitHandler<IFormData> = (data) => {
        ...
        setFilterValue(() => (sneakers: any[]) => sneakers.filter(sneaker => sneaker.gender === data.gender));
    ...
    return (
        ...
        >
            ...
            <GenderFilter setValue={setValue} setGender={setGender} setFilterValue={function (_value: SetStateAction<() => (sneakers: any[]) => any[]>): void {
